...
ExtComponents = {
    ...
    getComponents: function () {
        ...
        }], ['Forms', 'Number Field', 'A Text Field where you can only enter numbers',
        {
            ...
            fieldLabel: 'Number',
            name: 'numbervalue'
        }], ['Forms', 'Time Field', 'A Text Field where you can only enter a time',
        {
            xtype: 'timefield',
            fieldLabel: 'Time',
            name: 'timevalue'
        }], ['Forms', 'Date Field', 'A Text Field where you can only enter a date',
        {
            xtype: 'datefield',
            fieldLabel: 'Date',
            name: 'datevalue'
        ...
        // Simple Panels
        data.push(
        ['Panels', 'Panel', 'A simple panel with default layout',
        {
            xtype: 'panel',
            title: 'Panel'
        ...
        // Simples Layouts
        data.push(
        ['Layouts', 'Fit Layout', 'Layout containing only one element, fitted to container',
        {
            layout: 'fit',
            title: 'FitLayout Container'
        }], ['Layouts', 'Card Layout', 'Layout containing many elements, only one can be displayed at a time',
        {
            layout: 'card',
            title: 'CardLayout Container'
        }], ['Layouts', 'Anchor Layout', 'Layout containing many elements, sized with "anchor" percentage values',
        {
            layout: 'anchor',
            title: 'AnchorLayout Container'
        }], ['Layouts', 'Absolute Layout', 'Layout containing many elements, absolutely positionned with x/y values',
        {
            layout: 'absolute',
                    ...
                    handler: function () {
                        ...
                        for (var i = 0; i < cols; i++) {
                            for (var j = 0; j < rows; j++) {
                                config.items.push({
                                    html: (values.addcontent ? 'col ' + i + ', row ' + j : null)
                                });
                            }
                        }
                        var defaults = {};
                        ...
                        if (!isNaN(pad)) {
                            defaults.bodyStyle = 'padding:' + pad + 'px;';
                        }
            ...
            var w = new Ext.Window({
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        html: "* Size : can be a percentage of total width (i.e. 33%)," + "a fixed with (i.e. 120), or empty (autosize)<br/>" + "** Title : not set if empty"
                    }]
                }],
                buttons: [{
                    text: 'Ok',
                ...
                items: [{
                    ...
                    buttons: [{
                        ...
                        handler: function () {
                            ...
                            config.items.push({
                                region: 'center',
                                title: values.title_center || null
                            });
